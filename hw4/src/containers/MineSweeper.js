...
const MineSweeper = () => {
    ...
    const difficultyOnClick = () => {
        setDifficulty(!difficulty)
    }

    return (
        <div className='mineSweeper'>
        {startGame ? <Board boardSize={boardSize} mineNum={mineNum} backToHome={backToHomeOnClick}/> : <HomePage startGameOnClick={startGameOnClick} mineNumOnChange={mineNumOnChange} boardSizeOnChange={boardSizeOnChange} difficultyOnClick={difficultyOnClick} mineNum={mineNum} boardSize={boardSize} difficulty={difficulty}/>}
